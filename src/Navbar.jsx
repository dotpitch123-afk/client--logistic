...
export default function CargoCalcHeader() {
  ...
  return (
    <>
      <header className="bg-white font-inter border-b border-gray-200 font-semibold">
...
<div className="flex items-center space-x-2 mr-5  ">
  ...
  <span
    className="text-[#2274D4] align-middle mb-2"
    style={{
  ...
  <nav className="hidden md:flex mt-1 items-center space-x-6 ml-5">
   

    <a
  href="#features"
  className=" text-[#1C1C1E]  font-semibold text-[16px] leading-[150%] tracking-[0px] align-middle w-[65px] h-[24px]"
...
>
 Pricing
  ...
  href="#contact"
  className=" text-[#1C1C1E]  font-semibold text-[16px] leading-[150%] tracking-[0px] align-middle w-[88px] h-[24px]"
  style={{ fontFamily: 'Inter, sans-serif', opacity: 1 }}
>
   Contact Us
</a>
            ...
            {/* RIGHT: Register/Login + Demo Button */}
            <div className="hidden md:flex items-center space-x-6">
              <div className="flex items-center space-x-2 text-gray-700 transition-colors duration-200 cursor-pointer">
                ...
                <div className="text-[#1C1C1E]  font-semibold text-[16px] leading-[150%] tracking-[0px] align-middle  h-[24px]">
                  <a
                    href="/register"
              ...
              <button 
                className="text-white px-5 py-2.5 rounded-md text-sm font-medium transition-colors duration-200 shadow-sm"  
                style={{
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden border-t border-gray-200 mt-0 pt-4 pb-4 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                ...
                <button
  className="w-full bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-md shadow-sm transition-colors duration-200 text-center align-middle"
  style={{
