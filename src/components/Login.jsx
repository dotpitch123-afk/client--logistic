...
<div
  ...
  style={{
    background:
      "linear-gradient(90deg, rgba(72, 74, 230, 0.2) 0%, rgba(41, 96, 234, 0.2) 49.52%, rgba(218, 172, 185, 0.2) 100%)",
  }}
>
  <h2 className="text-2xl font-bold text-center mb-2">Hello Again!</h2>
...
<div className="relative mt-4">
  ...
  />
    ...
    {/* <input
      type="email"
      placeholder="Email Address"
      className="w-full px-4 py-3 border rounded-md bg-white focus:outline-none focus:ring-2"
    />
    <input
      type="password"
      placeholder="Password"
