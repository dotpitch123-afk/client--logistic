...
export default function LogisticsIndustries() {
  ...
  // }}>
  <div 
    className="rounded-[7px]  bg-[#EAEFFD] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 bg-cover bg-center"  
   
  >
      {/* <div className="bg-[#EAEFFD]  px-4 py-3"> */}
       <div className=" px-4 bg-[#EAEFFD] py-3">
...
const IndustriesTitle = () => (
  <div className=" overflow-hidden flex items-center justify-center ">
      ...
      <span className="text-lg  font-semibold text-gray-800 text-center   font-[600] text-[28px] sm:text-[36px] md:text-[48px] lg:text-[60px] leading-[68px] font-outfit ">
        Industries
      </span>
